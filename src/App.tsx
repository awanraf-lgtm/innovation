        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              <h3 className="text-lg font-bold mb-4">
                CellCase<span className="text-primary-400">Pro</span>
              </h3>
              <p className="text-gray-400 text-sm mb-4">
                Premium phone cases and accessories for your mobile devices. 
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white text-sm">iPhone Cases</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm">Samsung Cases</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white text-sm">Returns</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm">Size Guide</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex">
                ...
                />
                <button className="bg-primary-500 hover:bg-primary-600 px-4 py-2 rounded-r-md text-sm font-medium transition-colors">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center">
            <p className="text-gray-400 text-sm">
              © 2025 CellCase Pro. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
